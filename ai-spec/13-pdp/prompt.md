...
Implement complete PDP behavior.

## Requirements

Render images, name, brand, description, price, discount, options/variants, availability, add-to-cart, wishlist and related products where available. Prevent invalid/unavailable variant additions.

## Acceptance criteria

[ ] PDP loads correct product
