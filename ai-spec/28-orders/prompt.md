# Task 28: Orders & Account Order History
...
Show order number/date/total/items/variants/quantities/prices/discount/shipping/tax/total/address/payment status/fulfillment status and return status where available. Only current customer orders may be viewed.
...
Do not allow customers to alter financial/fulfillment state.
