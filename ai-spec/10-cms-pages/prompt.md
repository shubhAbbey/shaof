# Task 10: Landing, Sale, Campaign & Policy Pages
...
Implement dynamic CMS page routing.

## Requirements

Support landing, sale, campaign, brand-content and policy pages with SEO metadata and reusable sections. Keep CMS content routing deterministic and separate from commerce PLP routes.

## Acceptance criteria

[ ] Dynamic CMS routes work
[ ] Sale/landing pages render sections
[ ] SEO metadata works
[ ] Missing page produces proper 404

## Explicit non-goals

Do not duplicate product prices/inventory in Strapi.
