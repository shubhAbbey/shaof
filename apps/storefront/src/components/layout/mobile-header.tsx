      ...
      <div className="flex h-14 items-center justify-between px-3 border-b border-gray-100">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="p-1.5 text-gray-700 hover:text-brand-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 rounded-md"
          >
