# Task 15: Desktop Search Dropdown
...
Implement desktop autocomplete UX.

## Requirements

Dropdown must contain product suggestions with image/name/price, category names, collection names and View All Results. Product -> PDP; category -> PLP; collection -> PLP. Keyboard arrows, Enter, Escape. Enter with no active suggestion -> full search PLP.

## Acceptance criteria

[ ] Dropdown is compact
[ ] Product/category/collection destinations work
[ ] Enter behavior is deterministic
[ ] Keyboard navigation works
[ ] Loading/error/empty states work

## Explicit non-goals

Do not render a full PLP inside the desktop dropdown.
