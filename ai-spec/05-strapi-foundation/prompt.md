...
Configure Strapi as the CMS source of truth.

## Requirements

Set up Strapi, separate database, media handling and safe API access. Establish content publishing and environment configuration.

## Acceptance criteria

[ ] Strapi starts and persists content
[ ] Media configuration works
[ ] Public API access is secure
[ ] Admin works

## Explicit non-goals

Do not duplicate Medusa product master data.
