# Task 12: PLP Filters, Sorting & Infinite Scroll
...
Add filter, sorting, URL state and infinite-scroll behavior.

## Requirements

Support configured category/brand/price/size/color/availability/attribute filters, supported sorting modes, URL synchronization, browser back/forward, infinite pagination, duplicate prevention and loading/error/empty states.

## Acceptance criteria

[ ] Filters work together
[ ] URL is reproducible
[ ] Sorting works when supported
[ ] Infinite scroll appends without duplicates
[ ] API failure differs from zero results

## Explicit non-goals

Do not invent unsupported filter fields or ranking rules.
