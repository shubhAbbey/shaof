# Task 06: CMS Content Models & Section Registry
...
Create the CMS page and section model required by the MVP.

## Requirements

Implement homepage, landing, sale, campaign and brand-content page types. Add reusable sections: hero, banner, rich text, category tiles, collection carousel, product carousel/grid, promotional CTA and SEO metadata. Make section ordering data-driven.

## Acceptance criteria

[ ] All required page types exist
[ ] Sections are reusable
[ ] Ordering is CMS-driven
[ ] Product/collection references do not duplicate commerce facts

## Explicit non-goals

Do not implement arbitrary executable content or a custom CMS engine.
